export const rewards = [
  ...
  { id: 6, name: 'GCash', points: 1000, category: 'E-wallet', quantity: 100, variants: { type: 'denomination', options: ['1k', '5k', '10k', '25k', '50k'] }, image: 'https://placehold.co/400x300/00B0FF/FFFFFF?text=GCash+1k', 
    galleries: {
      '1k': ['https://placehold.co/400x300/00B0FF/FFFFFF?text=1k+Pesos+1', 'https://placehold.co/400x300/0099CC/FFFFFF?text=1k+Pesos+2', 'https://placehold.co/400x300/0088BB/FFFFFF?text=1k+Pesos+3', 'https://placehold.co/400x300/00AADD/FFFFFF?text=1k+Pesos+4'],
      '5k': ['https://placehold.co/400x300/FF6B00/FFFFFF?text=5k+Pesos+1', 'https://placehold.co/400x300/FF5500/FFFFFF?text=5k+Pesos+2', 'https://placehold.co/400x300/FF7722/FFFFFF?text=5k+Pesos+3', 'https://placehold.co/400x300/FF8833/FFFFFF?text=5k+Pesos+4'],
      '10k': ['https://placehold.co/400x300/00C853/FFFFFF?text=10k+Pesos+1', 'https://placehold.co/400x300/00B347/FFFFFF?text=10k+Pesos+2', 'https://placehold.co/400x300/00D95F/FFFFFF?text=10k+Pesos+3', 'https://placehold.co/400x300/00E066/FFFFFF?text=10k+Pesos+4'],
      '25k': ['https://placehold.co/400x300/9C27B0/FFFFFF?text=25k+Pesos+1', 'https://placehold.co/400x300/8E24AA/FFFFFF?text=25k+Pesos+2', 'https://placehold.co/400x300/7B1FA2/FFFFFF?text=25k+Pesos+3', 'https://placehold.co/400x300/AB47BC/FFFFFF?text=25k+Pesos+4'],
      '50k': ['https://placehold.co/400x300/F44336/FFFFFF?text=50k+Pesos+1', 'https://placehold.co/400x300/E53935/FFFFFF?text=50k+Pesos+2', 'https://placehold.co/400x300/D32F2F/FFFFFF?text=50k+Pesos+3', 'https://placehold.co/400x300/EF5350/FFFFFF?text=50k+Pesos+4']
    } },
  ...
  { id: 11, name: 'iPhone 16 Pro Max', points: 50000, category: 'Gadget', quantity: 3, variants: { type: 'color', options: ['Black Titanium', 'White Titanium', 'Natural Titanium', 'Desert Titanium'] }, image: 'https://placehold.co/400x300/2C2C2C/FFFFFF?text=Black+Titanium', 
    galleries: {
      'Black Titanium': ['https://placehold.co/400x300/2C2C2C/FFFFFF?text=Black+Titanium+1', 'https://placehold.co/400x300/1F1F1F/FFFFFF?text=Black+Titanium+2', 'https://placehold.co/400x300/0A0A0A/FFFFFF?text=Black+Titanium+3', 'https://placehold.co/400x300/3A3A3A/FFFFFF?text=Black+Titanium+4'],
      'White Titanium': ['https://placehold.co/400x300/E8E8E8/000000?text=White+Titanium+1', 'https://placehold.co/400x300/F5F5F5/000000?text=White+Titanium+2', 'https://placehold.co/400x300/FAFAFA/000000?text=White+Titanium+3', 'https://placehold.co/400x300/EFEFEF/000000?text=White+Titanium+4'],
  ...
  { id: 15, name: 'Yamaha Aerox 2025', points: 150000, category: 'Car', quantity: 2, variants: { type: 'color', options: ['Matte Black', 'Racing Blue', 'Matte Red'] }, image: 'https://placehold.co/400x300/1A1A1A/FFFFFF?text=Matte+Black+Aerox', 
    galleries: {
      'Matte Black': ['https://placehold.co/400x300/1A1A1A/FFFFFF?text=Black+Aerox+1', 'https://placehold.co/400x300/0D0D0D/FFFFFF?text=Black+Aerox+2', 'https://placehold.co/400x300/262626/FFFFFF?text=Black+Aerox+3', 'https://placehold.co/400x300/1F1F1F/FFFFFF?text=Black+Aerox+4'],
      'Racing Blue': ['https://placehold.co/400x300/0066CC/FFFFFF?text=Blue+Aerox+1', 'https://placehold.co/400x300/0055BB/FFFFFF?text=Blue+Aerox+2', 'https://placehold.co/400x300/0077DD/FFFFFF?text=Blue+Aerox+3', 'https://placehold.co/400x300/0044AA/FFFFFF?text=Blue+Aerox+4'],
      'Matte Red': ['https://placehold.co/400x300/B22222/FFFFFF?text=Red+Aerox+1', 'https://placehold.co/400x300/8B0000/FFFFFF?text=Red+Aerox+2', 'https://placehold.co/400x300/DC143C/FFFFFF?text=Red+Aerox+3', 'https://placehold.co/400x300/A52A2A/FFFFFF?text=Red+Aerox+4']
    } },
